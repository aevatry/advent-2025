This is the seventh day of the advent of code calendar.   
...
Caching was implemented in the recursive function for the initial solution to the problem due to long running times.
